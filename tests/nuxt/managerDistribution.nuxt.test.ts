...
describe('ManagerDistribution', () => {
  ...
  it('рядом с диаграммой — статистика словами', async () => {
    ...
    // ⚠ Плитки «Без ответственного» больше НЕТ: поле у сделки обязательное, и она всегда
    // показывала ноль (решение владельца 2026-09-06). Постоянный ноль не сообщает ничего.
