/**
 * Блокировка приложения при неподписанных актах — чистое ядро.
 *
 * Отчёты сделаны и выкачены; пока работа не принята актами, приложение сначала НАПОМИНАЕТ об этом
