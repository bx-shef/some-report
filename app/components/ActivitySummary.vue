 ...
 *
 * ⚠ Пока НИ ОДНОЙ страницы звонков не прочитано, их плитки показывают ПРОЧЕРК, а не ноль. Ноль на
 * экране означает «не звонил», и человек, открывший отчёт в первую секунду, прочитал бы его
 * именно так.
 *
 * ⚠ А вот отдельного признака «читаем прямо сейчас» у плиток НЕТ намеренно, хотя чтение идёт
 * минуты и числа растут по ходу. Плитка, замершая на прочерке до конца выборки, врала бы ровно
 * так же — просто в другую сторону; а два разных объяснения одной неполноты (прочерк в плитке и
 * строка «Читаем звонки: N записей» под ней) сбивают с толку сильнее, чем растущее число рядом с
 * этой строкой. Про неполноту говорит СТРАНИЦА, одним местом.
 */
