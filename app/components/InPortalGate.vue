...
<template>
  ...
  >
    <B24Alert
      ...
      description="Отчёт читает лиды и сделки вашего портала. Снаружи портала у него нет доступа к данным, поэтому показывать здесь нечего. Откройте раздел «CRM-аналитика» → «Приложения» и выберите нужный отчёт: «Аналитика по лидам» или «Сделки по менеджерам»."
    />
  </div>
