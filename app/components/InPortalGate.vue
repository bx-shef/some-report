...
<template>
  ...
  >
    <B24Alert
      ...
      description="Отчёты читают CRM и телефонию вашего портала. Снаружи портала у них нет доступа к данным, поэтому показывать здесь нечего. Откройте раздел «CRM-аналитика» портала и выберите нужный отчёт: «Аналитика по лидам», «Сделки по менеджерам» или «Активность пользователей»."
    />
  </div>
