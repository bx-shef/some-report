 ...
 * нажали». Общий у них вид — класс `.drill-number`, чтобы кликабельные числа во всех отчётах не
  ...
  <div class="space-y-4">
    ...
    >
      ...
      <ul class="space-y-3 md:hidden">
        ...
        <!-- ⚠ Итогов компании ПО СТАДИЯМ на телефоне нет, и это выбор, а не забывчивость: их
             столько же, сколько столбцов в таблице, и они заняли бы больше места, чем все строки
             менеджеров. Итог компании целиком остаётся кликабельным, а разрез по стадии человек
             берёт со строки нужного менеджера. На широком экране таблица даёт и то, и другое. -->
