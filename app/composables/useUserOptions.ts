 ...
 *
 * Зачем: отбор руководитель выставляет один и тот же изо дня в день — своё направление, свой
 * период, свою компанию, свой отдел. Заметнее всего это у порога разговора в отчёте 3: он
 * меняет ВСЕ числа отчёта, и работающему не по умолчанию пришлось бы выставлять его каждое
 * утро. Заставлять выбирать его заново при каждом открытии
