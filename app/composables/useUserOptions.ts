 ...
 *
 * Зачем: отбор в отчётах «Аналитика по лидам» и «Сделки по менеджерам» руководитель выставляет
 * один и тот же изо дня в день — своё направление, свой период, свою компанию. (У «Активности
 * пользователей» запоминания пока нет — #54.) Заставлять выбирать его заново при каждом открытии
